    ...
    <section className="min-h-screen bg-hero-pattern relative overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 font-medium animate-fade-in stagger-animation" style={{ '--stagger': '1' } as any}>
            Full Stack Developer & Problem Solver
          </p>
          
          {/* Description */}
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in stagger-animation" style={{ '--stagger': '2' } as any}>
            MTS Intern at GeeksforGeeks with expertise in MERN stack. 
            Passionate about building scalable web applications and solving complex problems.
          </p>
          
          {/* Contact Info */}
          <div className="flex flex-wrap justify-center gap-4 mb-8 text-sm text-muted-foreground animate-fade-in stagger-animation" style={{ '--stagger': '3' } as any}>
          ...
          {/* Action Buttons */}
          <div className="flex flex-wrap justify-center gap-4 mb-12 animate-fade-in stagger-animation" style={{ '--stagger': '4' } as any}>
            <Button 
              size="lg" 
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-primary/50 hover:bg-primary/10 transition-smooth px-8 hover-lift hover:scale-105"
            >
          ...
          {/* Social Links */}
          <div className="flex justify-center gap-6 animate-fade-in stagger-animation" style={{ '--stagger': '5' } as any}>
            <a 
              href="#" 
